...
class Task(BaseTask):
    ...
    def teste_1_inserir(self):
        cases = self.case_range("sequencia{}.in", 1, 2)
        binary = self.make("sequencia")
        self.test_cases(binary, cases)

    def teste_2_inverter(self):
        cases = self.case_range("sequencia{}.in", 3, 4)
        binary = self.make("sequencia")
        self.test_cases(binary, cases)

    def teste_3_transpor(self):
        cases = self.case_range("sequencia{}.in", 5, 6)
        binary = self.make("sequencia")
        self.test_cases(binary, cases)

    def teste_4_todos(self):
        cases = self.case_range("sequencia{}.in", 7, 15)
        binary = self.make("sequencia")
        self.test_cases(binary, cases)
