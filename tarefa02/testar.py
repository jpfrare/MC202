...
class Task(BaseTask):
    def teste_0_classificar_exemplo(self):
        cases = self.case_range("exemplo{}.in", 1, 2)
        binary = self.make("classificar")
        self.test_cases(binary, cases)

    def teste_1_classificar_homonimos(self):
        cases = self.case_range("homonimos{}.in", 1, 8)
        binary = self.make("classificar")
        self.test_cases(binary, cases)

    def teste_2_classificar_parentes(self):
        cases = self.case_range("parentes{}.in", 9, 12)
        binary = self.make("classificar")
        self.test_cases(binary, cases)

    def teste_3_consultas_registrar(self):
        cases = self.case_range("consultas{}.in", 1, 4)
        binary = self.make("consultas")
        self.test_cases(binary, cases)

    def teste_4_consultas_remover(self):
        cases = self.case_range("consultas{}.in", 5, 8)
        binary = self.make("consultas")
        self.test_cases(binary, cases)

    def teste_5_consultas_alterar(self):
        cases = self.case_range("consultas{}.in", 9, 12)
        binary = self.make("consultas")
        self.test_cases(binary, cases)
